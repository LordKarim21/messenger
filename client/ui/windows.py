...
from ui.login import Ui_Login_Dialog as login_ui_class
from ui.contacts import Ui_ContactsWindow as contacts_ui_class
from ui.chat import Ui_ChatMainWindow as chat_ui_class
...
class ContactsWindow(QMainWindow):
    ...
    def on_delete_contact_btn_pressed(self):
        try:
            ...
            QMessageBox.warning(self, 'Error', 'Please pick the contact')
